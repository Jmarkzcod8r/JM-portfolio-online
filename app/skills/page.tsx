...
<div className='ring-2 ring-gray-500 bg-gradient-to-br from-sky-900 to-purple-900 p-4 h-auto sm:max-h-[28em] w-auto sm:w-[30em] flex flex-wrap justify-around rounded-xl relative overflow-hidden shadow-2xl'>
